  ...
  <div className="page">
    <div className="contact-info">
      ...
      <div className="centered-row">
        <Shake><a className="right-gap" href="https://github.com/jackpsmith-git" target="_blank"><img src={github} height={40} style={{backgroundColor: 'white', maskImage: `url(${github})`, maskSize: 'contain', filter: 'brightness(0) invert(1)'}} /></a></Shake>
        ...
        <Shake><a href="https://www.nuget.org/profiles/jackpsmith" target="_blank"><img src={nuget} height={40} style={{backgroundColor: 'white', maskImage: `url(${nuget})`, maskSize: 'contain', filter: 'brightness(0) invert(1)'}} /></a></Shake>
      </div>
    </div>
  </div>
</div>
